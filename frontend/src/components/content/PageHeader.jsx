  ...
  return (
    <div className="flex flex-col border-b border-slate-200 pb-6">
      <div className="flex items-center gap-3 mb-2">
        ...
        <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">Content Studio</h1>
      </div>
      <p className="text-slate-500 ml-1">Create or Upload new assets for your campaigns.</p>
    </div>
  );
};
